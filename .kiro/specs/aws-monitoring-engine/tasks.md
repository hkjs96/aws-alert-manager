...
- [-] 2. Tag_Resolver 모듈 구현
  - [ ] 2.1 `common/tag_resolver.py` 구현
  ...
  - [ ]* 2.2 Tag_Resolver 속성 테스트 작성 (Property 2: 태그 임계치 우선 적용)
...
- [ ] 3. Checkpoint - Tag_Resolver 검증
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. SNS_Notifier 모듈 구현
  - [ ] 4.1 `common/sns_notifier.py` 구현
  ...
  - [ ]* 4.2 SNS_Notifier 속성 테스트 작성 (Property 7: 임계치 초과 알림 메시지 완전성)
  ...
  - [ ]* 4.3 SNS_Notifier 속성 테스트 작성 (Property 11: Remediation 완료 알림 메시지 완전성)
...
- [ ] 5. Collectors 모듈 구현
  ...
  - [ ] 5.2 `common/collectors/rds.py` 구현
  ...
  - [ ] 5.3 `common/collectors/elb.py` 구현
...
- [ ] 8. Remediation_Handler 구현
  ...
  - [ ] 8.2 `remediation_handler/handler.py` 구현 - Auto-Remediation 로직
  ...
  - [ ] 8.3 `remediation_handler/handler.py` 구현 - 리소스 삭제 및 태그 변경 처리
...
- [ ] 9. Checkpoint - Lambda 핸들러 검증
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 10. SAM 템플릿 작성
  - [ ] 10.1 `aws-monitoring-engine/template.yaml` 작성
