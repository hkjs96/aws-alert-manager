...
- [x] 1. Alarm Registry 데이터 등록 — 8개 리소스 타입 알람 정의 일괄 추가
  - [x] 1.1 Red: `tests/test_alarm_manager.py`에 8개 신규 리소스 타입 알람 정의 실패 테스트 작성
  ...
  - [x] 1.2 Green: `common/alarm_registry.py`에 8개 알람 정의 리스트 및 매핑 테이블 추가
...
- [x] 2. Common Constants 확장 — `common/__init__.py`
  - [x] 2.1 Red: `tests/test_alarm_manager.py`에 상수 검증 실패 테스트 작성
...
- [x] 4. Collectors 구현 — 8개 모듈 (common/collectors/)
  - [x] 4.1 Red: `tests/test_collectors.py`에 Lambda Collector 실패 테스트 작성
  ...
  - [x] 4.2 Green: `common/collectors/lambda_fn.py` 모듈 생성
  ...
  - [x] 4.3 Red: `tests/test_collectors.py`에 VPN Collector 실패 테스트 작성
  ...
  - [x] 4.4 Green: `common/collectors/vpn.py` 모듈 생성
    - `_get_ec2_client()` 싱글턴
  ...
  - [x] 4.5 Red: `tests/test_collectors.py`에 APIGW Collector 실패 테스트 작성
  ...
  - [x] 4.6 Green: `common/collectors/apigw.py` 모듈 생성
  ...
  - [x] 4.7 Red: `tests/test_collectors.py`에 ACM Collector 실패 테스트 작성
  ...
  - [x] 4.8 Green: `common/collectors/acm.py` 모듈 생성
    - `_get_acm_client()` 싱글턴
  ...
  - [x] 4.9 Red: `tests/test_collectors.py`에 Backup Collector 실패 테스트 작성
  ...
  - [x] 4.10 Green: `common/collectors/backup.py` 모듈 생성
  ...
  - [x] 4.11 Red: `tests/test_collectors.py`에 MQ Collector 실패 테스트 작성
  ...
  - [x] 4.12 Green: `common/collectors/mq.py` 모듈 생성
    - `_get_mq_client()` 싱글턴
  ...
  - [x] 4.13 Red: `tests/test_collectors.py`에 CLB Collector 실패 테스트 작성
  ...
  - [x] 4.14 Green: `common/collectors/clb.py` 모듈 생성
  ...
  - [x] 4.15 Red: `tests/test_collectors.py`에 OpenSearch Collector 실패 테스트 작성
  ...
  - [x] 4.16 Green: `common/collectors/opensearch.py` 모듈 생성
  ...
  - [x] 4.17 Refactor: 8개 Collector 코드 정리 및 전체 테스트 재실행
...
- [x] 5. Checkpoint — 8개 Collector 구현 완료 확인
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. CloudTrail 이벤트 + Remediation Handler — `remediation_handler/lambda_handler.py`
  - [x] 6.1 Red: `tests/test_remediation_handler.py`에 8개 신규 리소스 이벤트 실패 테스트 작성
  ...
  - [x] 6.2 Green: Remediation Handler에 8개 신규 리소스 이벤트 매핑 추가
...
- [x] 7. Tag Resolver 확장 — `common/tag_resolver.py`
  - [x] 7.1 Red: `tests/test_collectors.py`에 8개 신규 리소스 태그 조회 실패 테스트 작성
  ...
  - [x] 7.2 Green: `common/tag_resolver.py`의 `get_resource_tags()`에 8개 신규 타입 분기 추가
...
- [x] 9. Daily Monitor 통합 — `daily_monitor/lambda_handler.py`
  - [x] 9.1 Red: `tests/test_daily_monitor.py`에 8개 신규 Collector 통합 실패 테스트 작성
  ...
  - [x] 9.2 Green: Daily Monitor에 8개 신규 Collector 등록
...
- [x] 13. Alarm Manager 확장 — `treat_missing_data` + OpenSearch Compound Dimension
  - [x] 13.1 Red: `tests/test_alarm_manager.py`에 treat_missing_data 및 OpenSearch 디멘션 실패 테스트 작성
  ...
  - [x] 13.2 Green: `common/alarm_builder.py` treat_missing_data 지원 + `common/dimension_builder.py` OpenSearch 분기 추가
...
- [x] 14. Alarm Search 확장 — 신규 리소스 타입 접두사
  - [x] 14.1 Red: `tests/test_alarm_manager.py`에 신규 타입 알람 검색 실패 테스트 작성
  ...
  - [x] 14.2 Green: `common/alarm_search.py`의 `_find_alarms_for_resource()` 기본 폴백 목록에 8개 신규 타입 추가
...
- [x] 16. PBT — 설계 문서 Correctness Properties 10개
  ...
  - [x]* 16.4 PBT Property 4: ACM Full_Collection with Auto-Injected Tag
  ...
  - [x]* 16.5 PBT Property 5: APIGW _api_type Routing Correctness
  ...
  - [x]* 16.6 PBT Property 6: OpenSearch Compound Dimension Construction
  ...
  - [x]* 16.7 PBT Property 7: VPN treat_missing_data=breaching
  ...
  - [x]* 16.9 PBT Property 9: metric_name_to_key Round Trip
  ...
  - [x]* 16.10 PBT Property 10: HARDCODED_DEFAULTS Threshold Direction Consistency
