  ...
  return (
    <>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={isToggling}
              aria-label={monitoring ? "Turn monitoring off" : "Turn monitoring on"}
      ...
      <ConfirmDialog
        ...
        title={monitoring ? "Turn monitoring off?" : "Turn monitoring on?"}
        message={`${resource.name} (${resource.id}) monitoring will be ${monitoring ? "disabled" : "enabled"}. Continue?`}
        confirmLabel={monitoring ? "Turn Off" : "Turn On"}
        cancelLabel="Cancel"
        variant={monitoring ? "danger" : "default"}
