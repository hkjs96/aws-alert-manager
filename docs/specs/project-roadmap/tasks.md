...
- [ ] 0. Quick Wins — 블로커 해소 및 인프라 개선
  ...
  - [ ] 0.1 remaining-resources-e2e-test Task 10.4 완료
    ...
    - E2E 스펙: git 히스토리 `.kiro/specs/remaining-resources-e2e-test/tasks.md` Task 10.4 참조 (잔여 태스크는 `docs/specs/BACKLOG.md`)
    - _예상: 5분_
  ...
  - [ ] 0.3 extended-resource-monitoring PBT 마무리
    - git 히스토리 `.kiro/specs/extended-resource-monitoring/tasks.md` Task 16의 Correctness Properties 10개 PBT 작성 (잔여 태스크는 `docs/specs/BACKLOG.md`)
...
- [ ] 14. KI-009 동적 알람 방향 해소
  ...
  - [ ] 14.1 Threshold_LT_ prefix 설계
    - `docs/specs/` 에 `dynamic-alarm-direction/` 스펙 생성 (requirements + design + tasks)
...
- [ ] 15. global-service-alarm-notification 설계 + 구현
  ...
  - [ ] 15.1 Kiro Spec 작성
    - `docs/specs/global-service-alarm-notification/` 에 design.md + tasks.md 작성
...
- [ ] 16. metric-key-rename 설계 + 구현
  ...
  - [ ] 16.1 Kiro Spec 작성
    - `docs/specs/metric-key-rename/` 에 design.md + tasks.md 작성
